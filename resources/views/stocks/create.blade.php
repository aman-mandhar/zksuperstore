                        ...
                        <table class="table col-md-12" id="itemsTable">
                            <tbody class="col-md-12">
                                ...
                                <tr class="item-row col-md-12" data-type="{{ $item->type }}">
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <input type="number" step="0.01" class="form-control pur-value" value="{{ old('pur_value') }}"placeholder="Amount" required>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-group cgst-field">
                                            <input type="number" class="form-control" value="{{ old('cgst') }}" placeholder="CGST">
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-group sgst-field">
                                            <input type="number" class="form-control" value="{{ old('sgst') }}" placeholder="SGST">
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-group mrp-field">
                                            <input type="number" class="form-control" value="{{ old('mrp') }}" placeholder="MRP">
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-group sale_price-field">
                                            <input type="number" class="form-control" value="{{ old('sale_price') }}" placeholder="Sale Price">
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-group">
                                            <input type="number" step="0.01" class="form-control tot_points" value="{{ old('tot_points') }}" placeholder="Points" required>
                                        </div>
                                    </td>
                                    
                                    <td>
                                        <div class="form-group measure-field" style="display: none;">
                                            <input type="text" class="form-control" value="{{ old('measure') }}" placeholder="in weight">
                                        </div>
                                        <div class="form-group tot-no-of-items-field" style="display: none;">
                                            <input type="number" class="form-control" value="{{ old('tot_no_of_items') }}" placeholder="No. of Items">
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-group pur_bill_no-field">
                                             <input type="text" class="form-control" id="pur_bill_no" value="{{ old('pur_bill_no') }}" placeholder="Bill No">
                                        </div>
                                    </td>
                                    <td>
                                        <select name="merchant" id="merchant" class="form-control" required>
                                            ...
                                            @foreach($merchants as $merchant)
                                                <option value="value="{{ old($merchant->id) }}">{{ $merchant->name }}</option>
                                            @endforeach
                                        </select>
                                    </td>
